...
document.addEventListener('DOMContentLoaded', () => {
	// Only initialize AdminPanel when admin UI exists (prevents fetch errors on public site)
	if (document.getElementById('saveBtn')) {
		admin = new AdminPanel();
	} else {
		// No admin UI present — skip admin initialization on public site
		console.log('Admin UI not detected; skipping AdminPanel initialization.');
	}
});
